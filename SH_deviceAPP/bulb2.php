...
<div class="btn_wrap">
  ...
  <button class="btn" id="btn1" value="<?php echo $line; ?>"  data-speed="2100ms" >1</button>
  <button class="btn" id="btn2" value="<?php echo $line; ?>" data-speed="1400ms" >2</button>
  <button class="btn" id="btn3" value="<?php echo $line; ?>" data-speed="700ms" >3</button>
</div>
<h1 id="demo"></h1>
<h1 id="demos"></h1>
</div>
